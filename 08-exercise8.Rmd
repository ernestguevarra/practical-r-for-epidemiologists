...
```{r, eval = FALSE, fig.align = "center", fig.pos = "H", fig.retina = 1}
plot(Time, Cases, type = "l")
```

```{r, eval = TRUE, fig.align = "center", fig.pos = "H", fig.retina = 1}
plot(as.factor(Time), Cases, type = "l")
```
...
```{r, echo = TRUE, eval = TRUE, fig.align = "center", fig.pos = "H", fig.retina = 1}
barplot(table(marital))
```
...
In [***Exercise 1 Getting acquainted with R***](#exercise1), we saw how the `plot()` function could be applied to a fitted object:
